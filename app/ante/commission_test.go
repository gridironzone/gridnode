...
import (
	...
	gridAnte "github.com/Gridchain/gridnode/app/ante"
...
func createValidator(app *gridapp.GridchainApp, ctx sdk.Context, delegateAmount sdk.Int, status stakingtypes.BondStatus, delegatorAddress sdk.AccAddress, valPubKey cryptotypes.PubKey) sdk.ValAddress {
