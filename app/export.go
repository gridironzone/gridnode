...
// file.
func (app *GridchainApp) ExportAppStateAndValidators(
...
func (app *GridchainApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
...
func ExportAppState(name string, app *GridchainApp, ctx sdk.Context) {
