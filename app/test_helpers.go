...
func setup(withGenesis bool, invCheckPeriod uint, blacklist []sdk.AccAddress) (*GridchainApp, GenesisState) {
	db := dbm.NewMemDB()
...
func Setup(isCheckTx bool) *GridchainApp {
	return SetupWithBlacklist(isCheckTx, []sdk.AccAddress{})
}

// Setup initializes a new SimApp. A Nop logger is set in SimApp.
func SetupWithBlacklist(isCheckTx bool, blacklist []sdk.AccAddress) *GridchainApp {
...
func SetupFromGenesis(isCheckTx bool, genesisTransformer func(*GridchainApp, GenesisState) GenesisState) *GridchainApp {
...
func AddTestAddrs(app *GridchainApp, ctx sdk.Context, accNum int, accAmt sdk.Int) []sdk.AccAddress {
	return addTestAddrs(app, ctx, accNum, accAmt, CreateRandomAccounts)
}

func addTestAddrs(app *GridchainApp, ctx sdk.Context, accNum int, accAmt sdk.Int, strategy GenerateAccountStrategy) []sdk.AccAddress {
