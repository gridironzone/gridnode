...
#### CLI
```shell
gridnoded tx dispensation claim LiquidityMining --from grid1l7hypmqk2yc334vc6vmdwzp5sdefygj2ad93p5 --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0rowan --node tcp://rpc.gridchain.finance:80 --chain-id gridchain
```
