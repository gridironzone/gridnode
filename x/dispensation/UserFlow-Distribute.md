...
```shell
gridnoded tx dispensation create Airdrop output.json grid1l7hypmqk2yc334vc6vmdwzp5sdefygj2ad93p5 --from grid1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0rowan
```
Sample output
```json
{
...
```shell
gridnoded tx dispensation run 2_grid1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd Airdrop --from grid1l7hypmqk2yc334vc6vmdwzp5sdefygj2ad93p5 --yes --gas auto --gas-adjustment=1.5 --gas-prices 1.0rowan
```
Sample output
```json
{
