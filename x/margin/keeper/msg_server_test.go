...
import (
	...
	"github.com/Gridchain/gridnode/x/margin/keeper"
...
func TestKeeper_ForceClose(t *testing.T) {
	...
	for _, tt := range table {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx, app := test.CreateTestAppMarginFromGenesis(false, func(app *gridapp.GridchainApp, genesisState gridapp.GenesisState) gridapp.GenesisState {
