...
func init() {
	...
	proto.RegisterType((*MsgUpdateRowanCollateral)(nil), "gridnode.margin.v1.MsgUpdateRowanCollateral")
	proto.RegisterType((*MsgUpdateRowanCollateralResponse)(nil), "gridnode.margin.v1.MsgUpdateRowanCollateralResponse")
...
func (c *msgClient) UpdateRowanCollateral(ctx context.Context, in *MsgUpdateRowanCollateral, opts ...grpc.CallOption) (*MsgUpdateRowanCollateralResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridnode.margin.v1.Msg/UpdateRowanCollateral", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateRowanCollateral_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridnode.margin.v1.Msg/UpdateRowanCollateral",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
