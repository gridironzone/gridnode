...
import (
	...
	"github.com/Gridchain/gridnode/x/clp/types"
)
...
func CreateTestAppClp(isCheckTx bool) (sdk.Context, *gridapp.GridchainApp) {
	return CreateTestAppClpWithBlacklist(isCheckTx, []sdk.AccAddress{})
}

func CreateTestAppClpWithBlacklist(isCheckTx bool, blacklist []sdk.AccAddress) (sdk.Context, *gridapp.GridchainApp) {
...
func CreateTestAppClpFromGenesis(isCheckTx bool, genesisTransformer func(*gridapp.GridchainApp, gridapp.GenesisState) gridapp.GenesisState) (sdk.Context, *gridapp.GridchainApp) {
	gridapp.SetConfig(false)
...
func GeneratePoolsFromFile(app *gridapp.GridchainApp, keeper clpkeeper.Keeper, ctx sdk.Context) []*types.Pool {
