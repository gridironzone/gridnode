...
import (
	...
	"github.com/Gridchain/gridnode/x/ethbridge/keeper"
...
func CreateTestApp(isCheckTx bool) (*app.GridchainApp, sdk.Context) {
...
func CreateSimulatorApp(isCheckTx bool) (sdk.Context, *app.GridchainApp) {
	gridchainApp := app.Setup(isCheckTx)
	ctx := gridchainApp.BaseApp.NewContext(isCheckTx, tmproto.Header{})
