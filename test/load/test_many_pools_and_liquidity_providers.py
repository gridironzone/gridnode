...
# }
#
# (2) use rocksb, see https://raw.githubusercontent.com/Gridchain/gridchain-devops/1218ff79b22ab2a6bd22b81d6aa4385a247cafc9/scripts/gridnode/testing/gridnode_n_node_network_simulator.py?token=GHSAT0AAAAAABLH7LII5AAWD6YDWG7THBHGYW7DSVA
#
...
from gridtool.gridchain import ROWAN, STAKE, ROWAN_DECIMALS
...
class Test:
    ...
    def setup(self):
        ...
        # minted rowans are transferred there, you can see the minting process here: https://github.com/Gridchain/gridnode/blob/master/x/clp/keeper/rewards.go#L54
        # For LPD, we only transfer the existing funds in CLP to the LP's wallet, you can see here: https://github.com/Gridchain/gridnode/blob/8b2f9c45130c79e07555735185fbe1d00279fab0/x/clp/keeper/pool.go#L128
