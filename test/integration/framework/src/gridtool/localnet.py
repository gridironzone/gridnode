...
def run_localnet_hook():
    ...
    # /tmp/localnet/bin/gridnoded add-genesis-account gridchain-validator 10000000000000000000rowan --keyring-backend test --home /tmp/localnet/config/gridchain/gridchain-testnet-1
    # /tmp/localnet/bin/gridnoded add-genesis-account gridchain-source 10000000000000000000rowan --keyring-backend test --home /tmp/localnet/config/gridchain/gridchain-testnet-1
