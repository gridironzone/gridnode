...
from gridtool.gridchain import ROWAN


def get_grid_tx_fees(ctx):
    return {ROWAN: gridchain.grid_tx_fee_in_rowan}


def get_grid_burn_fees(ctx):
    return {ROWAN: gridchain.grid_tx_burn_fee_in_rowan, ctx.ceth_symbol: gridchain.grid_tx_burn_fee_in_ceth}
