...
def test_transfer(env):
    ...
    gridnoded.send_and_check(env.faucet, gridnoded.create_addr(), {gridchain.ROWAN: 10 ** gridchain.ROWAN_DECIMALS})
...
class TestGridnodedEnvironment:
    ...
    def test_balances(self):
        ...
        try:
            ...
            test_transfer_amount = {gridchain.ROWAN: 10**gridchain.ROWAN_DECIMALS}
            for i in range(number_of_validators):
