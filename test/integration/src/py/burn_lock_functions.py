...
from test_utilities import get_gridchain_addr_balance, advance_n_ethereum_blocks, \
    ...
    get_shell_output_json, EthereumToGridchainTransferRequest, GridchaincliCredentials, RequestAndCredentials, \
    gridnoded_binary
...
def transfer_ethereum_to_gridchain(transfer_request: EthereumToGridchainTransferRequest,
...
def transfer_argument_parser() -> argparse.ArgumentParser:
    ...
    Transfer from Ethereum to Gridchain
    """))
    parser.add_argument(
        '--gridchain_address',
        type=str,
...
def process_args(cmdline: List[str]) -> RequestAndCredentials:
    ...
    transfer_request = EthereumToGridchainTransferRequest.from_args(args)
