...
def test_create_pools(
    ...
    # wait for balance
    test_utilities.wait_for_gridchain_addr_balance(gridaddress, "rowan", target_rowan_balance, basic_transfer_request.gridnoded_node)
    ...
    if pools is None:
        ...
        current_rowan_balance = current_rowan_balance - change_amount - gridchain_fees_int
        assert(test_utilities.get_gridchain_addr_balance(gridaddress, basic_transfer_request.gridnoded_node, "rowan") == current_rowan_balance)
    ...
    assert(txn["code"] == 14)
    get_pools(basic_transfer_request.gridnoded_node)
    current_rowan_balance = current_rowan_balance - gridchain_fees_int
    assert(test_utilities.get_gridchain_addr_balance(gridaddress, basic_transfer_request.gridnoded_node, "rowan") == current_rowan_balance)
    assert(test_utilities.get_gridchain_addr_balance(gridaddress, basic_transfer_request.gridnoded_node, "ceth") == current_ceth_balance)
...
def test_pools(
    ...
    # wait for balance
    test_utilities.wait_for_gridchain_addr_balance(gridaddress2, "rowan", target_rowan_balance, basic_transfer_request.gridnoded_node)
    ...
    slip_pct = 0.01
    balance = test_utilities.get_gridchain_addr_balance(gridaddress, basic_transfer_request.gridnoded_node, "rowan")
    ...
    basic_transfer_request.amount = 10 ** 19
    txn = swap_pool(basic_transfer_request, "rowan", gridchain_symbol, credentials)
    assert(txn["code"] == 27)
    get_pools(basic_transfer_request.gridnoded_node)
    current_rowan_balance = current_rowan_balance - gridchain_fees_int
    assert(test_utilities.get_gridchain_addr_balance(gridaddress, basic_transfer_request.gridnoded_node, "rowan") == current_rowan_balance)
