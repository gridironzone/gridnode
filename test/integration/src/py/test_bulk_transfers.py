...
def test_bulk_transfers(
    ...
    request: EthereumToGridchainTransferRequest = copy.deepcopy(basic_transfer_request)
    ...
    for a in new_addresses:
        ...
        test_utilities.wait_for_gridchain_addr_balance(a, "rowan", amount, basic_transfer_request.gridnoded_node, 180)
    text_file = open("pfile.cmds", "w")
    simple_credentials = GridchaincliCredentials(
