...
def test_burn_ibc_coins(
    ...
    request, credentials = generate_test_account(
        ...
        target_rowan_balance=gridchain_fees_int * 2 + small_amount
    )
...
def test_lock_ibc_coins(
    ...
    feedface_transfer_request.gridchain_address = rowan_source
    ...
    burn_lock_functions.send_from_gridchain_to_gridchain(feedface_transfer_request, rowan_source_integrationtest_env_credentials)
