...
from burn_lock_functions import GridchaincliCredentials
from test_utilities import get_required_env_var, get_shell_output


def gridchain_cli_credentials_for_test(key: str) -> GridchaincliCredentials:
    """Returns GridchaincliCredentials for the test keyring with from_key set to key"""
    return GridchaincliCredentials(
        keyring_passphrase="",
...
def create_new_gridaddr_and_credentials() -> (str, GridchaincliCredentials):
