...
from test_utilities import get_required_env_var, GridchaincliCredentials, get_optional_env_var, \
...
def build_request() -> (EthereumToGridchainTransferRequest, GridchaincliCredentials):
