...
import string
import random
from dispensation_envutils import create_new_gridaddr_and_key, send_sample_rowan, balance_check, \
...
def test_create_new_claim(claimType):
    ...
    send_sample_rowan(from_address, gridchain_address, amount, keyring_backend, chain_id, "")
    time.sleep(5)
