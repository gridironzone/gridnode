...
# Test scenarios (Kevin): https://github.com/Gridchain/gridnode/blob/feature/min-commission/docs/tutorials/commission.md
...
# Upgrades:
# - https://github.com/Gridchain/gridchain-devops/blob/main/scripts/gridnode/release/testing/upgrade_path.json
# - https://github.com/Gridchain/gridnode/blob/68f69eb7e390363f336ec7a235ab7e564bf5dabb/scripts/upgrade-integration.sh#L39-L39
