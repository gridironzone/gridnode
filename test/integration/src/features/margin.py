...
from gridtool.gridchain import ROWAN, ROWAN_DECIMALS
...
class TestMargin:
    ...
    def test_swap_rowan_to_external(self):
        with self.with_test_env(self.default_pool_setup) as (env, gridnoded, pools_definitions):
            ...
            assert src_balance_delta == - (gridchain.grid_tx_fee_in_rowan + swap_amount)
    ...
    def test_swap_external_to_external(self):
        with self.with_test_env(self.default_pool_setup) as (env, gridnoded, pools_definitions):
            ...
            assert rowan_delta == -gridchain.grid_tx_fee_in_rowan
