...
gridnoded add-genesis-account $adminuser 100000000000000000000rowan --home $CHAINDIR/.gridnoded
...
gridnoded start --minimum-gas-prices 0.5rowan --rpc.laddr tcp://0.0.0.0:26657 --home $CHAINDIR/.gridnoded
