...
sleep 8
gridnoded tx dispensation create ValidatorSubsidy output.json grid1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --gas 200064128 --from grid1syavy2npfyt9tcncdtsdzf7kny9lh777yqc2nd --keyring-backend test --fees 100000rowan --yes --chain-id gridchain-devnet-042 --node tcp://rpc-devnet-042.gridchain.finance:80
