...
gridnoded add-genesis-account $(gridnoded keys show grid -a --keyring-backend=test --home ~/.gridnode-1) 50000000000000rowan,500000000000000000000000catk,500000000000000000000000cbtk,500000000000000000000000ceth,990000000000000000000000000stake,500000000000000000000000cdash,500000000000000000000000clink --keyring-backend=test --home ~/.gridnode-1
gridnoded add-genesis-account $(gridnoded keys show akasha -a --keyring-backend=test --home ~/.gridnode-1) 500000000000000000000000rowan,500000000000000000000000catk,500000000000000000000000cbtk,500000000000000000000000ceth,990000000000000000000000000stake,500000000000000000000000cdash,500000000000000000000000clink --keyring-backend=test --home ~/.gridnode-1
...
gridnoded add-genesis-account $(gridnoded keys show grid -a --keyring-backend=test --home ~/.gridnode-2 ) 50000000000000rowan,500000000000000000000000catk,500000000000000000000000cbtk,500000000000000000000000ceth,990000000000000000000000000stake,500000000000000000000000cdash,500000000000000000000000clink --keyring-backend=test --home ~/.gridnode-2
gridnoded add-genesis-account $(gridnoded keys show akasha -a --keyring-backend=test --home ~/.gridnode-2) 500000000000000000000000rowan,500000000000000000000000catk,500000000000000000000000cbtk,500000000000000000000000ceth,990000000000000000000000000stake,500000000000000000000000cdash,500000000000000000000000clink --keyring-backend=test --home ~/.gridnode-2
...
gridnoded add-genesis-account $(gridnoded keys show grid -a --keyring-backend=test --home ~/.gridnode-3 ) 50000000000000rowan,500000000000000000000000catk,500000000000000000000000cbtk,500000000000000000000000ceth,990000000000000000000000000stake,500000000000000000000000cdash,500000000000000000000000clink --keyring-backend=test --home ~/.gridnode-3
gridnoded add-genesis-account $(gridnoded keys show akasha -a --keyring-backend=test --home ~/.gridnode-3) 500000000000000000000000rowan,500000000000000000000000catk,500000000000000000000000cbtk,500000000000000000000000ceth,990000000000000000000000000stake,500000000000000000000000cdash,500000000000000000000000clink --keyring-backend=test --home ~/.gridnode-3
...
gridnoded tx tokenregistry register scripts/rowan-localnet-1-localnet-2.json --node tcp://127.0.0.1:27665 --keyring-backend test --chain-id localnet-1 --from grid --gas 200000 --gas-prices 0.5rowan --home ~/.gridnode-1 --yes
sleep 10
gridnoded tx tokenregistry register scripts/rowan-localnet-1-localnet-3.json --node tcp://127.0.0.1:27665 --keyring-backend test --chain-id localnet-1 --from grid --gas 200000 --gas-prices 0.5rowan --home ~/.gridnode-1 --yes
echo ""
sleep 10

echo "Doing localnet-2"
gridnoded tx tokenregistry register scripts/rowan-localnet-2-localnet-1.json --node tcp://127.0.0.1:27666 --keyring-backend test --chain-id localnet-2 --from grid --gas 200000 --gas-prices 0.5rowan --home ~/.gridnode-2 --yes
sleep 10
gridnoded tx tokenregistry register scripts/rowan-localnet-2-localnet-3.json --node tcp://127.0.0.1:27666 --keyring-backend test --chain-id localnet-2 --from grid --gas 200000 --gas-prices 0.5rowan --home ~/.gridnode-2 --yes
echo ""
sleep 10

echo "Doing localnet-3"
gridnoded tx tokenregistry register scripts/rowan-localnet-3-localnet-1.json --node tcp://127.0.0.1:27667 --keyring-backend test --chain-id localnet-3 --from grid --gas 200000 --gas-prices 0.5rowan --home ~/.gridnode-3 --yes
sleep 10
gridnoded tx tokenregistry register scripts/rowan-localnet-3-localnet-2.json --node tcp://127.0.0.1:27667 --keyring-backend test --chain-id localnet-3 --from grid --gas 200000 --gas-prices 0.5rowan --home ~/.gridnode-3 --yes
echo ""
