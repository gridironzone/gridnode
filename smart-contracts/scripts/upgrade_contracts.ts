...
import {setupRopstenDeployment, setupGridchainMainnetDeployment} from "../src/hardhatFunctions";
...
async function main() {
    ...
    const factories = await container.resolve(GridchainContractFactories) as GridchainContractFactories
