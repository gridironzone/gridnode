...
export async function setupDeployment(c: DependencyContainer) {
    ...
    switch(deploymentName) {
        case "gridchain":
        case "gridchain-1":
            setupGridchainMainnetDeployment(c, hre, deploymentName)
            break
        case undefined:
            break
        default:
...
export async function setupGridchainMainnetDeployment(c: DependencyContainer, hre: HardhatRuntimeEnvironment, deploymentName: "gridchain" | "gridchain-1") {
