...
contract("BridgeBank", function (accounts) {
  ...
  describe("Bridge token creation", function () {
    ...
    it("should burn eRowan to create rowan on gridchain", async function () {
    ...
    it("should NOT burn eRowan to create rowan on gridchain if user is blocklisted", async function () {
      // Add sender to the blocklist
    ...
    it("should mint eRowan to transfer Rowan from gridchain to ethereum", async function () {
      function convertToHex(str) {
        let hex = '';
        for (let i = 0; i < str.length; i++) {
            hex += '' + str.charCodeAt(i).toString(16);
