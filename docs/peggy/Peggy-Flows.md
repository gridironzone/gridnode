...
- A user sends a lock tx with the gridnoded specifying rowan as the token to lock up, the amount of tokens to send, and the desired ethereum address recipient. This TX emits a cosmos event with all of these data fields.
...
3. Ethereum Native Asset on Ethereum Being Transferred to Gridchain
...
4. Cosmos Native Pegged Asset on Ethereum Being Transferred Back to Gridchain
