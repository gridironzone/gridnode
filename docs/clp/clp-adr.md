...
For the Gridchain MVP, CLP module provides the following functionalities 
...
## Decisions 
 ...
 - **Swap**
  ...
  ## References
 https://github.com/Gridchain/gridnode/blob/develop/docs/1.Liquidity%20Pools%20Architecture.md
