...
import (
	...
	"github.com/Gridchain/gridnode/x/clp/test"
	clptypes "github.com/Gridchain/gridnode/x/clp/types"
	ethtest "github.com/Gridchain/gridnode/x/ethbridge/test"
...
func TestIntegration(t *testing.T) {
	...
	for _, tc := range tt {
		t.Run(tc.Name, func(t *testing.T) {
			ctx, app := test.CreateTestAppClpFromGenesis(false, func(app *gridapp.GridchainApp, genesisState gridapp.GenesisState) gridapp.GenesisState {
...
func endBlock(t *testing.T, app *gridapp.GridchainApp, ctx sdk.Context, height int64) {
...
func getResults(t *testing.T, app *gridapp.GridchainApp, ctx sdk.Context, tc TestCase) TestResults {
